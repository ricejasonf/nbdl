...
extern "C" {
  void nbdl_test_js_promise_test1(int, int
                                , int, int, int, int
                                , int, int, int, int);
}

TEST_CASE("Create a promise using a C API function.", "[js]")
{
  constexpr auto get_handle = nbdl::js::detail::get_handle;
  nbdl::js::init();
  ...
  , nbdl::js::get_handle(input0)
  , nbdl::js::get_handle(input1)
  , nbdl::js::get_handle(input2)
  , nbdl::js::get_handle(input3)
  , nbdl::js::get_handle(input4)
  , nbdl::js::get_handle(input5)
  , nbdl::js::get_handle(input6)
  , nbdl::js::get_handle(input7)
  );

  nbdl::run_async(hana::make_tuple(
    NBDL_JS_PROMISE_C_FUNC(
      nbdl_test_js_promise_test1
    , input0
    , input1
    , input2
    , input3
