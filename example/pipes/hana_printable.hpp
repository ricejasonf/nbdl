/*
@file
Defines `example::experimental::print`.

@copyright Louis Dionne 2013-2016

MODIFIED TO NOT DEPEND ON BOOST
...
#ifndef NBDL_EXAMPLE_HANA_PRINTABLE_HPP
#define NBDL_EXAMPLE_HANA_PRINTABLE_HPP
...
namespace boost::hana::experimental
{
    template <typename T>
    struct Printable;
