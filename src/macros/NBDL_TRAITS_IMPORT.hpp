...
#define NBDL_TRAITS_IMPORT(TYPENAME, ...) \
  static constexpr auto TYPENAME_inst_ = TYPENAME{};  \
  NBDAL_TRAITS_IMPORT_(TYPENAME_inst_, ...)           \
...
#define NBDL_TRAITS_IMPORT2(NAME, MNAME) \
  using MNAME = decltype(NAME[BOOST_HANA_STRING(#MNAME)])::type;
